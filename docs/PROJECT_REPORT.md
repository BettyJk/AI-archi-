...
The platform digitises and automates the **automotive packaging clearance study** (vehicle
"implantation"). In classic OEM engineering this is done by hand in CATIA: an
...
- **Rules encoded in a system prompt + a deterministic classifier** - the SCR structural rules and
  ...
  real engineering thresholds). This dual encoding trades some duplication for reliability: the number
